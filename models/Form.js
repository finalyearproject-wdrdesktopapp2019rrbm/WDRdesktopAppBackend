...
var ObservationslipForm = {
    ...
    getAllObservationslipForms: function(callback) {
        return db.query("Select * from  observationslip ORDER BY Date DESC LIMIT 20", callback);
    },
...
Observationslip.MSLPr, Observationslip.TimeMarksBarograph, Observationslip.TimeMarksAnemograph, Observationslip.OtherTMarks, Observationslip.Remarks, Observationslip.SubmittedBy, Observationslip.Approved, Observationslip.SoilMoisture, Observationslip.SoilTemperature, Observationslip.sunduration,
Observationslip.trend, Observationslip.windrun, Observationslip.speciOrMetar, Observationslip.UnitOfWindSpeed, Observationslip.IndOrOmissionOfPrecipitation,
